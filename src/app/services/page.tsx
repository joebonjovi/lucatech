  ...
  return (
    <>
      <PageHero
        ...
        description="From security cameras, video doorbells, and smart locks to Wi-Fi, smart home automation, audio and speakers, and home theater, Luca Technologies installs and configures connected home technology for homeowners."
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Services" },
        ]}
